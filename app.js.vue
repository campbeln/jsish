    ...
    core.app = {
        ...
        init: function () {
            ...
            if (!bInit) {
                ...
                core.app.data.selected = /*core.app.data.$scope.selected =*/ { //! neek /* //!core.app.data.$scope.selected =*/
                ...
                core.resolve(document.querySelector("DIV[ngTooltip]"), "ngTooltip.options", { //# neek jQuery
                    position: 'left',
                    maxWidth: 450,
                    offset: -5
                });
                ...
                if (core.io.web.queryString.get("sfod", true)) {
                    ...
                    //!neek core.app.ip.update(core.app.data.selected.Ip, core.app.data.selected.Mask);
                    ...
                    if (core.type.str.is(core.io.web.queryString.get("email", true), true)) {
                        core.app.domain.d8semail(core.io.web.queryString.get("email", true));
                    }
        ...
        img: {
            ...
            thumbUrl: function (sDomainOrIP) {
                ...
                if (core.type.str.is(sDomainOrIP, true, true) && sDomainOrIP.indexOf(".") > 0) {
                    sDomainOrIP = sDomainOrIP.replace(/\[\.\]/g, ".");
        ...
        block: function (oOptions) {
            ...
            core.lib.ui.sync(function () {
                core.resolve(true, core.app.data.api, sTargetPath, {});
            });
            ...
            //};
//console.log(fnReturnVal, core.resolve(core.app.data.api, sTargetPath));
            return fnReturnVal;
        }, //# core.app.block
        ...
        domain: {
            ...
            update: function (sDomain, bIsNS) {
                ...
                core.lib.ui.sync(function () {
                    ...
                    //!neek core.app.data.$scope.isns = bIsNS;
            ...
            function (vData, bLoadInCurrentTab) {
                ...
                tab: function (sTabName) {
                    ...
                    switch (sTabName) {
                        ...
                        case "queue":
                        case "queues": {
                            console.log(core.resolve(core, "app.queue.init"));
                            core.type.fn.poll(
                                function () {
                                    return core.type.fn.is(core.resolve(core, "app.queue.init"));
                                },
                                {
                                    onsuccess: function () { core.app.queue.init(); },
                                    timeout: 7500,
                                    wait: 500
                                }
                            )();
        ...
        dialog: core.extend(
            ...
            help: function ($panel) {
                ...
                $panel.each(function() {
                    //console.log(this);
                    sCurrent = $(this).html(); //# neek jQuery
