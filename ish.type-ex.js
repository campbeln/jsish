 ...
 */
 ...
 //# If this is a .or'd .query, break on the first bIsMatch
 if (oOptions.or) {
 if (bIsMatch) {
 break;
 }
 }
 //# Else this is an (implicit) AND .query, so break on the first non-bIsMatch
 else if (!bIsMatch) {
 break;
 }
 }
 ...
 */
 ...
 //# cp, clone, toArr, join, mv, rm, has, prune
 obj: function () {
 //#
